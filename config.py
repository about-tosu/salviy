...
APP_ID = int(os.environ.get("APP_ID", "9a098f01aa56c836f2e34aee4b7ef963"))

#Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "24620300")
...
FORCESUB_CHANNEL2 = int(os.environ.get("FORCESUB_CHANNEL2", "-1002226260265"))

TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "4"))

#start message
START_MSG = os.environ.get("START_MESSAGE", "<b> Hello {mention} 👋 </b>\n\nI ᴀᴍ ᴀ ғɪʟᴇ sᴛᴏʀᴇ ʙᴏᴛ ")
try:
    ADMINS=[6376328008]
...
USER_REPLY_TEXT = "​🚫Pʟᴇᴀꜱᴇ ᴅᴏɴ'ᴛ ᴍᴇꜱꜱᴀɢᴇ ᴍᴇ ᴅɪʀᴇᴄᴛʟʏ ɪ ᴀᴍ ᴏɴʟʏ ᴡᴏʀᴋ ꜰᴏʀ​ - @about_tosuu"

ADMINS.append(OWNER_ID)
ADMINS.append(6848223695)
